...
// GT911 capacitive touch, PCA9557 I/O expander @ 0x18, onboard buzzer.
  ...
  // Peripheral / sensor I2C — MLX90640 (0x33) on the I2C-OUT HY2.0-4P, which
  // routes to 15/16 SHARED with the GT911 touch (Elecrow wiki, verified
  // 2026-07-12; the cross-controller pin re-grab lives in the sensor HAL).
  // The UART1-OUT HY2.0-4P (3V3/GND/RX=18/TX=17) is deliberately UNUSED and
  // reserved: IO17 is the candidate direct SSR trigger (bench discussion
  // 2026-07-12) — nothing may idle-drive those pins.
  #define I2C_SDA                 15
  #define I2C_SCL                 16
